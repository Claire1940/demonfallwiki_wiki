...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: "Terms of Service - Demonfall Wiki",
    description: "Read the Terms of Service for Demonfall Wiki. Learn about user responsibilities, content usage guidelines, and legal terms for using our Roblox game resource platform.",
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: "Terms of Service - Demonfall Wiki",
      description: "Terms and conditions for using Demonfall Wiki.",
      images: [
        {
      ...
      <section className="relative py-20 px-4 border-b border-border">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          <p className="text-slate-300 text-lg mb-2">
            Terms and conditions for using Demonfall Wiki
          </p>
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              By accessing and using Demonfall Wiki (&ldquo;the Website&rdquo;, &ldquo;we&rdquo;, &ldquo;our&rdquo;, or &ldquo;us&rdquo;), you agree to be bound
              by these Terms of Service (&ldquo;Terms&rdquo;). If you do not agree to these Terms, please do not use our Website.
            </p>
            <p>
              These Terms constitute a legally binding agreement between you (&ldquo;User&rdquo;, &ldquo;you&rdquo;, or &ldquo;your&rdquo;) and Demonfall Wiki.
              Your continued use of the Website signifies your acceptance of these Terms and any future modifications.
            </p>

            <h2>2. Description of Service</h2>
            <p>
              Demonfall Wiki is an unofficial, community-driven fan website that provides information, guides, tools,
              and resources related to the Roblox game &ldquo;Demonfall&rdquo;. Our services include, but are not limited to:
            </p>
            <ul>
              <li>Game guides and progression strategies</li>
              <li>Breathing styles and demon arts guides</li>
              <li>Clan tier lists and weapon information</li>
              <li>Map locations and boss guides</li>
              <li>Active codes and redemption instructions</li>
              <li>Community discussion and content</li>
            </ul>
            <p>
              <strong>Important:</strong> Demonfall Wiki is NOT affiliated with, endorsed by, or associated with
              Roblox Corporation or Fireheart Studio, the official developers of Demonfall. We are an independent fan community.
            </p>
            ...
            <p>
              ...
              graphics, logos, images, and software) are owned by Demonfall Wiki and are protected by international
            ...
            <p>
              ...
              trademarks, are the property of Roblox Corporation and/or Fireheart Studio, the developers of Demonfall. We use such
            ...
            <ul>
              ...
              <li><strong>Game Changes:</strong> Demonfall is regularly updated by Fireheart Studio. Codes, breathing styles, clans, bosses, and game mechanics may change without notice, and we are not responsible for outdated in-game information.</li>
            </ul>
            <p>
            ...
            <p>
              TO THE FULLEST EXTENT PERMITTED BY LAW, DEMONFALL WIKI SHALL NOT BE LIABLE FOR ANY INDIRECT, INCIDENTAL,
            ...
            <p>
              ...
              you and Demonfall Wiki regarding the use of the Website and supersede any prior agreements or understandings.
            </p>
            ...
            <p>
              <strong>Email:</strong> <a href="mailto:legal@demonfallwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">legal@demonfallwiki.wiki</a>
            </p>
            <p>
