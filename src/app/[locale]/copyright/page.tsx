...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: 'Copyright Notice - Demonfall Wiki',
    description: 'Copyright and intellectual property information for Demonfall Wiki. Learn about content ownership, fair use, DMCA policy, and how to report copyright infringement.',
    robots: {
      index: false,
      follow: true,
      googleBot: {
    ...
    openGraph: {
      ...
      title: 'Copyright Notice - Demonfall Wiki',
      description: 'Copyright and intellectual property information for Demonfall Wiki.',
      images: [
        {
      ...
      <section className="py-12 px-4">
        <div className="container mx-auto max-w-4xl">
          <div className="prose prose-invert prose-slate max-w-none">
            ...
            <p>
              © 2026 Demonfall Wiki. All rights reserved.
            </p>
            <p>
              Unless otherwise noted, all original content on this website, including but not limited to text,
              graphics, logos, guides, articles, and compilations, is the property of Demonfall Wiki and is
              protected by international copyright laws.
            </p>

            <h3>1.2 Game Assets and Trademarks</h3>
            <p>
              Demonfall Wiki is an <strong>unofficial fan-made website</strong> and is NOT affiliated with,
              endorsed by, or associated with:
            </p>
            <ul>
              <li><strong>Roblox Corporation</strong> - Owner of the Roblox platform</li>
              <li><strong>Fireheart Studio</strong> - Creators of the Demonfall game</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li>Character names, breathing styles, and demon arts</li>
              <li>In-game items, clans, and mechanics</li>
            </ul>
            <p>
            ...
            <ul>
              ...
              <li><strong>Demonfall</strong> - Trademark of Fireheart Studio</li>
              <li><strong>Demonfall Wiki</strong> - Our own branding (not affiliated with the game)</li>
            </ul>
            <p>
              ...
              affiliation with Demonfall Wiki.
            </p>
            ...
            <p>
              ...
              Demonfall Wiki<br />
              Email: <a href="mailto:dmca@demonfallwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@demonfallwiki.wiki</a>
            </p>
            <p>
            ...
            <ul>
              <li>Provide clear attribution to &ldquo;Demonfall Wiki&rdquo;</li>
              <li>Include a link back to the original page (if digital)</li>
              <li>Do not imply endorsement or affiliation</li>
            </ul>
            <p>
              Example attribution: <em>&ldquo;Source: Demonfall Wiki (demonfallwiki.wiki)&rdquo;</em>
            </p>
            ...
            <p>
              <strong>General Inquiries:</strong> <a href="mailto:copyright@demonfallwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">copyright@demonfallwiki.wiki</a><br />
              <strong>DMCA Notices:</strong> <a href="mailto:dmca@demonfallwiki.wiki" className="text-[hsl(var(--nav-theme-light))] hover:underline">dmca@demonfallwiki.wiki</a>
            </p>
            <p>
